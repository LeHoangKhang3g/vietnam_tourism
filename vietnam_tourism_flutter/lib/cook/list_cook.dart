...
import 'package:vietnam_tourism_flutter/cook/cook.dart';
...
class _CookScreenState extends State<CookScreen>{
  ...
  Widget build(BuildContext context){
    cooks=MyApp.repository.cooks.where((element) => element.placeId==widget.place.id);

    return Scaffold(
      appBar: AppBar(title: const Text("Món ăn")),
      body: RefreshIndicator(
        child: ListView.builder(
          itemCount:cooks.length,

          itemBuilder: (BuildContext context , index) {
            return CookPost(cook: cooks.elementAt(index));
