...
import 'package:vietnam_tourism_flutter/cook/list_cook.dart';
...
import 'package:vietnam_tourism_flutter/posts/list_post.dart';
...
class _PlaceDetailState extends State<PlaceDetail>{
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Chi tiết địa danh"),
      ),
      body: ListView(
        children: [
          Container(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>CookScreen(widget.place)));
                          },
                          icon: Icon(
                        ...
                        Text(MyApp.repository.cooks.where((cook) => cook.placeId==widget.place.id ).toList().length.toString()),
                        IconButton(
                          onPressed: (){
                        ...
                        IconButton(
                          onPressed: (){
                            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>PostScreen(widget.place)));
                          },
                          icon: Icon(
                            Icons.list,
                            color: Colors.blue[400],
                        ...
                        Text(MyApp.repository.posts.where((post) => post.placeId==widget.place.id).toList().length.toString()),
                      ],
                    ),
                    const Divider(color: Colors.black,),
