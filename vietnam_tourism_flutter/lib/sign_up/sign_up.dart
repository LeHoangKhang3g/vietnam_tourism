...
class _SignUpState extends State<SignUp> {
  ...
  void signUp(){
    API(url: "http://10.0.2.2:8000/api/sign-up")
    .postSignUp(Account(0, _controller1.text, _controller2.text, _controller4.text, birthday, _controller5.text, "avatar1.jpg", "background1.jpg"))
    .then((value){
          ...
          Container(
            ...
            child:  OutlinedButton( 
              onPressed: () {
                ...
                else if(_controller1.text.isEmpty||_controller2.text.isEmpty||_controller3.text.isEmpty||_controller4.text.isEmpty||_controller4.text.isEmpty){
                  showDialog(
                    context: context, 
                    builder: (BuildContext context)=>AlertDialog(
                      title: const Text("Thông báo"),
